...
public interface PratoRepository extends JpaRepository<Prato, Long> {
    ...
    @Query("SELECT p FROM Prato p WHERE p.preco <= :preco AND p.tempoDePreparo <= :tempo")
    List<Prato> findPratosRapidosEBaratos(@Param("preco") BigDecimal preco, @Param("tempo") Integer tempo);
